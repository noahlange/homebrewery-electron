...
!(function() {
  ...
  module.exports = (function(window, document) {
    ...
    NumberToken.prototype.toJSON = function() {
      var json = this.constructor.prototype.constructor.prototype.toJSON.call(
        this
      );
  ...
  module.exports = (function(window, document) {
    ...
    function TimeoutEventStream(options) {
      ...
      var timeout =
        typeof options == 'number'
          ? +options
          : 'timeout' in options ? +options.timeout : 333;
    ...
    function MouseEventStream() {
      ...
      var pointermove =
        'PointerEvent' in window
          ? 'pointermove'
          : 'MSPointerEvent' in window ? 'MSPointerMove' : 'mousemove';
    ...
    function MouseButtonEventStream() {
      ...
      var pointerup =
        'PointerEvent' in window
          ? 'pointerup'
          : 'MSPointerEvent' in window ? 'MSPointerUp' : 'mouseup';
      var pointerdown =
        'PointerEvent' in window
          ? 'pointerdown'
          : 'MSPointerEvent' in window ? 'MSPointerDown' : 'mousedown';
  ...
  module.exports = (function(window, document) {
    ...
    var cssCascade = {
      ...
      getDefaultStyleForTag: function getDefaultStyleForTag(tagName) {
        ...
        var style = (this.defaultStylesForTag[tagName] = getComputedStyle(
          element
        ));
                ...
                for (var j = decls.length - 1; j >= 0; j--) {
                  if (decls[j].type == 'DECLARATION') {
                    if (decls[j].name == cssPropertyName) {
                      ...
                      var currentPriority = cssCascade.computeSelectorPriorityOf(
                        rules[i].selector
                      );
  ...
  module.exports = function(window, document, cssRegions) {
    ...
    cssRegions.NamedFlow.prototype.getRegionsByContent = function getRegionsByContent(
      node
    ) {
      var regions = [];
    ...
    var cssRegions = {
      ...
      layoutContentInLastRegionWhenReady: function(
        ...
        if (
          ...
          var didOverflow = this.extractOverflowingContent(
            region
          ).hasChildNodes();
